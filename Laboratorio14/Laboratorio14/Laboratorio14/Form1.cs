...
namespace Laboratorio14
{
    public partial class frmProductos : Form
    {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            if (nuevo)
            {
                ...
                try
                {
                    ...
                    if (i > 0) MessageBox.Show("Registro ingresado correctamente!");
                }
                catch (Exception ex)
                {
            ...
            else
            {
                ...
                {
                    int i = cmd.ExecuteNonQuery();
                    if (i > 0) MessageBox.Show("Registro actualizado correctamente!");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Error: " + ex.ToString());
        ...
        private void tsbEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                int i = cmd.ExecuteNonQuery();
                if (i > 0) MessageBox.Show("Registro eliminado correctamente!");
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error: " + ex.ToString());
